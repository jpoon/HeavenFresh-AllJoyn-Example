...
extern PCSTR c_AirPurifierIntrospectionXml;

ref class AirPurifierProducer;

public interface class IAirPurifierProducer
{
    event Windows::Foundation::TypedEventHandler<AirPurifierProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<AirPurifierProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<AirPurifierProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<AirPurifierProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class AirPurifierProducer sealed : [Windows::Foundation::Metadata::Default] IAirPurifierProducer
{
public:
    AirPurifierProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~AirPurifierProducer();

    // The implementation of IAirPurifierService that will handle method calls and property requests.
    property IAirPurifierService^ Service
    {
        IAirPurifierService^ get() { return m_serviceInterface; }
        void set(IAirPurifierService^ value) { m_serviceInterface = value; }
    }
    ...
    virtual event Windows::Foundation::TypedEventHandler<AirPurifierProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<AirPurifierProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<AirPurifierProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<AirPurifierProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
...
private:
    static void CallPowerONHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallPowerOFFHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallResetHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallSendSoftwareUpgradeFileHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    ...
    IAirPurifierService^ m_serviceInterface;
