...
public:
    ...
    Windows::Foundation::IAsyncOperation<OnboardingConfigureWiFiResult^>^ ConfigureWiFiAsync(Windows::Devices::AllJoyn::AllJoynMessageInfo^ info , _In_ Onboarding^ interfaceMemberInputArg);
