...
// Methods
IAsyncOperation<OnboardingConfigureWiFiResult^>^ OnboardingServiceEventAdapter::ConfigureWiFiAsync(_In_ AllJoynMessageInfo^ info, _In_ Onboarding^ interfaceMemberInputArg)
{
    auto args = ref new OnboardingConfigureWiFiCalledEventArgs(info, interfaceMemberInputArg);
