...
void OnboardingProducer::CallConfigureWiFiHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message)
{
    ...
    if (producer->Service != nullptr)
    {
        ...
        Onboarding^ inputArg0;
        TypeConversionHelpers::GetAllJoynMessageArg(alljoyn_message_getarg(message, 0), "(ssn)", &inputArg0);

        create_task(producer->Service->ConfigureWiFiAsync(callInfo, inputArg0)).then([busObject, message](OnboardingConfigureWiFiResult^ result)
        {
            int32 status;
            ...
            status = TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(outputs, 0), "n", result->OutputArg);
            if (AllJoynStatus::Ok != status)
            {
                alljoyn_busobject_methodreply_status(busObject, message, static_cast<QStatus>(status));
...
void OnboardingProducer::CallGetScanInfoHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message)
{
    ...
    if (producer->Service != nullptr)
    {
        ...
        create_task(producer->Service->GetScanInfoAsync(callInfo)).then([busObject, message](OnboardingGetScanInfoResult^ result)
        {
            ...
            status = TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(outputs, 0), "q", result->OutputArg);
            if (AllJoynStatus::Ok != status)
            {
                alljoyn_busobject_methodreply_status(busObject, message, static_cast<QStatus>(status));
                alljoyn_msgarg_destroy(outputs);
            ...
            status = TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(outputs, 1), "a(sn)", result->OutputArg2);
            if (AllJoynStatus::Ok != status)
            {
                alljoyn_busobject_methodreply_status(busObject, message, static_cast<QStatus>(status));
                alljoyn_msgarg_destroy(outputs);
...
"    <arg type=\"ssn\" direction=\"in\" />"
"    <arg type=\"n\" direction=\"out\" />"
"  </method>"
"  <method name=\"Connect\"></method>"
"  <method name=\"Offboard\"></method>"
"  <method name=\"GetScanInfo\">"
"    <arg type=\"q\" direction=\"out\" />"
"    <arg type=\"a(sn)\" direction=\"out\" />"
"  </method>"
