...
IAsyncOperation<OnboardingConfigureWiFiResult^>^ OnboardingConsumer::ConfigureWiFiAsync(_In_ Onboarding^ interfaceMemberInputArg)
{
    return create_async([this, interfaceMemberInputArg]() -> OnboardingConfigureWiFiResult^
    {
        ...
        TypeConversionHelpers::SetAllJoynMessageArg(alljoyn_msgarg_array_element(inputs, 0), "(ssn)", interfaceMemberInputArg);
