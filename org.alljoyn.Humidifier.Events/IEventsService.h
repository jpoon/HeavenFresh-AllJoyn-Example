...
public interface class IEventsService
{
public:
    ...
    Windows::Foundation::IAsyncOperation<EventsGetVersionResult^>^ GetVersionAsync(Windows::Devices::AllJoyn::AllJoynMessageInfo^ info);
