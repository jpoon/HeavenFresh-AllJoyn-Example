...
void EventsWatcher::UnregisterFromBus()
{
    ...
    {
        PCSTR interfaces[] = { "org.alljoyn.Humidifier.Events" };
    ...
    _In_ const alljoyn_msgarg aboutDataArg)
{
    ...
    if (alljoyn_aboutobjectdescription_hasinterface(objectDescription, "org.alljoyn.Humidifier.Events"))
    {
        AllJoynServiceInfo^ args = ref new AllJoynServiceInfo(
            AllJoynHelpers::MultibyteToPlatformString(name),
            AllJoynHelpers::GetObjectPath(objectDescription, "org.alljoyn.Humidifier.Events"),
            port);
