...
// Methods
// Property Reads
IAsyncOperation<EventsGetVersionResult^>^ EventsServiceEventAdapter::GetVersionAsync(_In_ AllJoynMessageInfo^ info)
{
    auto args = ref new EventsGetVersionRequestedEventArgs(info);
    AllJoynHelpers::DispatchEvent([=]() {
        GetVersionRequested(this, args);
    });
    return EventsGetVersionRequestedEventArgs::GetResultAsync(args);
}
