...
private:
    ...
    static void CallSetFlowToHIHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallSetFlowToMEDHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallSetFlowToLOWHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallSetFlowToQUIETHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallSetFlowToAUTOHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallSetTimerTo8HHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallSetTimerTo2HHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallSetTimerTo1HHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallSetTimerToOffHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
