...
ref class ActionsSignals;

public interface class IActionsSignals
{
};

public ref class ActionsSignals sealed : [Windows::Foundation::Metadata::Default] IActionsSignals
{
public:
internal:
