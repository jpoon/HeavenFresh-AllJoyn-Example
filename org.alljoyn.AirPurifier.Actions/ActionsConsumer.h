...
public:
    ...
    // Call the SetFlowToHI method
    Windows::Foundation::IAsyncOperation<ActionsSetFlowToHIResult^>^ SetFlowToHIAsync();
    // Call the SetFlowToMED method
    Windows::Foundation::IAsyncOperation<ActionsSetFlowToMEDResult^>^ SetFlowToMEDAsync();
    // Call the SetFlowToLOW method
    Windows::Foundation::IAsyncOperation<ActionsSetFlowToLOWResult^>^ SetFlowToLOWAsync();
    // Call the SetFlowToQUIET method
    Windows::Foundation::IAsyncOperation<ActionsSetFlowToQUIETResult^>^ SetFlowToQUIETAsync();
    // Call the SetFlowToAUTO method
    Windows::Foundation::IAsyncOperation<ActionsSetFlowToAUTOResult^>^ SetFlowToAUTOAsync();
    // Call the SetTimerTo8H method
    Windows::Foundation::IAsyncOperation<ActionsSetTimerTo8HResult^>^ SetTimerTo8HAsync();
    // Call the SetTimerTo2H method
    Windows::Foundation::IAsyncOperation<ActionsSetTimerTo2HResult^>^ SetTimerTo2HAsync();
    // Call the SetTimerTo1H method
    Windows::Foundation::IAsyncOperation<ActionsSetTimerTo1HResult^>^ SetTimerTo1HAsync();
    // Call the SetTimerToOff method
    Windows::Foundation::IAsyncOperation<ActionsSetTimerToOffResult^>^ SetTimerToOffAsync();
