...
IAsyncOperation<ActionsSetPowerToOffResult^>^ ActionsConsumer::SetPowerToOffAsync()
{
    return create_async([this]() -> ActionsSetPowerToOffResult^
    {
        ...
        QStatus status = alljoyn_proxybusobject_methodcall(
            ProxyBusObject,
            "org.alljoyn.AirPurifier.Actions",
            "SetPowerToOff",
            inputs,
            argCount,
            message,
...
IAsyncOperation<ActionsSetFlowToHIResult^>^ ActionsConsumer::SetFlowToHIAsync()
{
    return create_async([this]() -> ActionsSetFlowToHIResult^
    {
...
IAsyncOperation<ActionsSetFlowToMEDResult^>^ ActionsConsumer::SetFlowToMEDAsync()
{
    return create_async([this]() -> ActionsSetFlowToMEDResult^
    {
...
IAsyncOperation<ActionsSetFlowToLOWResult^>^ ActionsConsumer::SetFlowToLOWAsync()
{
    return create_async([this]() -> ActionsSetFlowToLOWResult^
    {
...
IAsyncOperation<ActionsSetFlowToQUIETResult^>^ ActionsConsumer::SetFlowToQUIETAsync()
{
    return create_async([this]() -> ActionsSetFlowToQUIETResult^
    {
...
IAsyncOperation<ActionsSetFlowToAUTOResult^>^ ActionsConsumer::SetFlowToAUTOAsync()
{
    return create_async([this]() -> ActionsSetFlowToAUTOResult^
    {
...
IAsyncOperation<ActionsSetTimerTo8HResult^>^ ActionsConsumer::SetTimerTo8HAsync()
{
    return create_async([this]() -> ActionsSetTimerTo8HResult^
    {
...
IAsyncOperation<ActionsSetTimerTo2HResult^>^ ActionsConsumer::SetTimerTo2HAsync()
{
    return create_async([this]() -> ActionsSetTimerTo2HResult^
    {
...
IAsyncOperation<ActionsSetTimerTo1HResult^>^ ActionsConsumer::SetTimerTo1HAsync()
{
    return create_async([this]() -> ActionsSetTimerTo1HResult^
    {
...
IAsyncOperation<ActionsSetTimerToOffResult^>^ ActionsConsumer::SetTimerToOffAsync()
{
    return create_async([this]() -> ActionsSetTimerToOffResult^
    {
...
int32 ActionsConsumer::JoinSession(_In_ AllJoynServiceInfo^ serviceInfo)
{
    ...
    alljoyn_interfacedescription description = alljoyn_busattachment_getinterface(m_nativeBusAttachment, "org.alljoyn.AirPurifier.Actions");
